...
const lowerPopulation = zooAnimals.filter(function(x) {
    return x.population < 5
})

console.log(lowerPopulation)

const largerPopulationArrow = zooAnimals.filter(x => {
    x.population < 5
})

console.log(largerPopulationArrow) //This is giving me an empty array, will come back to work on this.
...
populationTotal = zooAnimals.reduce((total, amount) => ({
    population: total.population + amount.population,
}))
